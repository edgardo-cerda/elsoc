...
variable_list <- readxl::read_excel(path = 'C:/Users/edgar/Dropbox/ELSOC/1_Cuestionario_y_Listado_Variables/2_Listado_de_variables_definitivo/0A_Listado_Variables_Global_ELSOC_v2021jul.xlsx',
                                        sheet = '2_Items_Total') %>%
    janitor::clean_names() %>%
